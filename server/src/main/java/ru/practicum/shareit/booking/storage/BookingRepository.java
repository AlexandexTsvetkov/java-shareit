...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("select book " +
            ...
            "where b.id = ?1 " +
            "and book.status = ?2 ")
    List<Booking> findBookingsByBookerIdAndByStatusOrderByStart(long bookerId, BookingStatus status);
    ...
    @Query("select book " +
            ...
            "order by book.start")
    Optional<Booking> findBookingByIdAndOwnerOrBookerId(long id, long userId);
