...
public class BookingService {
    ...
    public Collection<BookingDto> findAllByUser(long userId, State state) {
        ...
        if (state == State.CURRENT) {
            ...
            bookings = bookingStorage.findBookingsByBookerIdAndByStatusOrderByStart(userId, state.toString());
        } else {
    ...
    public Collection<BookingDto> findAllByOwner(long userId, State state) {
        ...
        if (state == State.CURRENT) {
            ...
            bookings = bookingStorage.findBookingsByOwnerAndStatus(userId, state.toString());
        } else {
